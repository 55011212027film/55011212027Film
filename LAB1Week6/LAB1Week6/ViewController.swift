...
class ViewController: UIViewController,UINavigationControllerDelegate,UIImagePickerControllerDelegate {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        //1
        let fileURL = NSBundle.mainBundle().URLForResource("purple-galaxy-space-hd-wallpaper-1920x1200-4605", withExtension: "jpg")
    ...
    @IBAction func mountSliderValueChanged(sender: UISlider) {
        ...
        let sliderVulue = sender.value
        
        let outputImage = self.oldPhoto(beginImage, withAmount: sliderVulue)
    ...
    func oldPhoto(img: CIImage,withAmount intensity: Float) -> CIImage{
        ...
        //2
        let ramdom = CIFilter(name: "CIRandomGenerator")
        
        //3
        let lighten = CIFilter(name: "CIColorControls")
        lighten.setValue(ramdom.outputImage, forKey: kCIInputImageKey)
        ...
        composite.setValue(sepia.outputImage, forKey: kCIInputBackgroundImageKey)
